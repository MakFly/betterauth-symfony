...
class FlexInstaller
{
    ...
    public static function postInstall(Event $event): void
    {
        ...
        $io->write([
            ...
            '',
            '<comment>OAuth / Social Login (optional):</comment>',
            '  To enable Google OAuth, edit <info>config/packages/better_auth.yaml</info>:',
            '',
            '  <fg=cyan>oauth:</fg>',
            '  <fg=cyan>    providers:</fg>',
            '  <fg=cyan>        google:</fg>',
            '  <fg=green>            enabled: true</fg>  <fg=yellow># Change to true</fg>',
            '  <fg=cyan>            client_id: \'%env(GOOGLE_CLIENT_ID)%\'</fg>',
            '  <fg=cyan>            client_secret: \'%env(GOOGLE_CLIENT_SECRET)%\'</fg>',
            '  <fg=cyan>            redirect_uri: \'%env(APP_URL)%/auth/oauth/google/callback\'</fg>',
            '',
            '  Then add to your <info>.env</info>:',
            '  <fg=cyan>GOOGLE_CLIENT_ID=your_client_id</fg>',
            '  <fg=cyan>GOOGLE_CLIENT_SECRET=your_client_secret</fg>',
            '',
            '  Get credentials at: <comment>https://console.cloud.google.com/apis/credentials</comment>',
            '',
